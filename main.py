...
# importing login
from function import login, logout, check_status, apply_shares, check_IPO, limit_login
...
if __name__ == '__main__':
    ...
    for i, each_account in enumerate(credentials):
        ...
        if apply:
            ...
            print(list_rank)
            apply_shares(chromeBrowser=chromeBrowser,each_account=each_account,list_rank=list_rank)
        else:
